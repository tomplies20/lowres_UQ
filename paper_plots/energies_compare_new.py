...
point_proton_radii_1 = np.loadtxt('/Users/pleazy/PycharmProjects/uncertainty_quantification/post_sampling/imsrg_data/energies_calcium_48_1MeV_coupled.txt')[:, 1]
...
point_proton_radii_2 = np.loadtxt('/Users/pleazy/PycharmProjects/uncertainty_quantification/post_sampling/imsrg_data/energies_calcium_48_25MeV_coupled.txt')[:, 1]

print(np.std(point_proton_radii_1))
print(np.std(point_proton_radii_2))
...
plt.savefig('./plots/energy_distribution_ca48.pdf', dpi=300)
plt.show()
